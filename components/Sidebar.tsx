...
import { LayoutGrid, BookOpen, FileText, Layers } from "lucide-react";
...
export default function Sidebar({
  ...
  const navItems = [
    { id: "all", label: "All Articles", icon: LayoutGrid, count: null },
    { id: "guides", label: "In-Depth Guides", icon: FileText, count: 80 },
    { id: "stories", label: "Tech Stories", icon: BookOpen, count: 20 },
  ];
  return (
    <aside className="hidden w-64 shrink-0 flex-col border-r border-line bg-surface md:flex">
        ...
        {navItems.map((item) => {
          ...
          return (
            <button
              ...
              className={`group flex w-full items-center gap-3 rounded-lg px-3 py-2.5 text-left text-sm font-ui font-medium transition-all ${
                active
      ...
      <div className="p-4 mt-auto border-t border-line">
        ...
        <div className="rounded-lg overflow-hidden border border-line bg-surface-soft">
